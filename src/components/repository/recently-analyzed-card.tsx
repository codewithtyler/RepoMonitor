...
export function RecentlyAnalyzedCard({ repositories }: RecentlyAnalyzedCardProps) {
  console.log('[RecentlyAnalyzedCard/Component] Mounting with repositories:', repositories.length);
  ...
  console.log('[RecentlyAnalyzedCard/Component] Sorted and filtered to:', sortedRepos.length, 'repositories');
  ...
  return (
    <div className="space-y-2">
      {sortedRepos.map((repo) => {
        console.log(`[RecentlyAnalyzedCard/Component] Rendering repository:`, repo.owner + '/' + repo.name);
        return (
          <div
            key={repo.id}
